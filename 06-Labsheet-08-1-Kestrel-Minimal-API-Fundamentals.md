...
2. กลับไปที่หน้าเบราว์เซอร์แล้วกดปุ่ม **Refresh (F5)** สังเกตว่าเกิดอะไรขึ้น และอธิบายสั้นๆ ว่าทำไมจึงเป็นเช่นนั้น
   - **คำตอบ** หน้าเว็บจะล่ม เข้าไม่ได้ ขึ้นว่า ERR_CONNECTION_REFUSED
<img width="1917" height="1095" alt="image" src="https://github.com/user-attachments/assets/8d06e9b4-fc24-4c01-a0e9-6f1a13d8cc6e" />
...
- .NET Minimal API กินทรัพยากรน้อยกว่า รันเร็ว ไม่ต้องลงโปรแกรมเสริม เขียนจบในไฟล์เดียว เหมาะกับบอร์ด IoT มากกว่า
- LAMP Stack กินแรมและซีพียูเยอะกว่า ต้องติดตั้งทั้ง Apache และ PHP ยุ่งยาก แต่ได้เปรียบเรื่องมีปลั๊กอินสำหรับเว็บทั่วไปเยอะกว่า
3. นักศึกษาคิดว่าการเพิ่ม `/api/` เข้าไปใน route นั้นมีประโยชน์อย่างไรบ้าง ถ้าไม่ใส่จะเกิดปัญหาอะไรบ้าง
- ประโยชน์ ช่วยแยกให้รู้ชัดเจนว่าเป็น URL สำหรับดึงข้อมูล JSON ไม่ใช่หน้าเว็บ และช่วยให้จัดระเบียบระบบความปลอดภัยง่ายขึ้น
ถ้าไม่ใส่ ชื่อ URL อาจไปซ้ำกับหน้าเว็บปกติจนระบบสับสน และจัดการสิทธิ์ความปลอดภัยยากขึ้น
